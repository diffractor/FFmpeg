...
#define FFMPEG_CONFIGURATION "--target-os=mingw32 --arch=x86 --cross-prefix=i686-w64-mingw32- --enable-cross-compile --enable-runtime-cpudetect --enable-static --disable-shared --enable-small --enable-x86asm --disable-inline-asm --enable-zlib --disable-programs --disable-doc --disable-avfilter --disable-network --disable-encoders --disable-muxers --disable-devices --disable-filters --enable-muxer=avif --disable-protocols --enable-protocol=file --disable-pthreads"
